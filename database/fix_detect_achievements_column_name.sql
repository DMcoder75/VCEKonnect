-- ================================================================
-- FIX: detect_subject_achievements() column name error
-- ================================================================
-- Issue: Function references gs.achieved_minutes but actual column is minutes_achieved
-- ================================================================
...
BEGIN
  ...
  -- FIXED: Use minutes_achieved instead of achieved_minutes
  SELECT COUNT(*)
  ...
  WHERE gp.user_id = p_user_id
    ...
    AND ((gs.minutes_achieved::numeric / 60) / gs.hours_target) >= 1.0;
...
-- ================================================================
-- USAGE: Run this script, then test again:
-- SELECT detect_subject_achievements('580b9eb1-ea3c-4581-9103-780afbedcc83');
-- ================================================================
